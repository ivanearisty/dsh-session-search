...
const CLIENT_EXTERNALS: readonly string[] = [
  ...
  'react-dom/client',
  '@deepseek-ai/cordis',
  // Shell-preloaded dynamic row (PRELOADED_CLIENT_EXTERNALS): its factory is
  // in the module table before boot, so it MUST stay a require() here.
...
export default defineConfig({
  ...
  outputOptions: {
    ...
    banner: `window.__ModuleLoader__.load({ id: ${JSON.stringify(pkg.name)}, factory: (require) => { const process = { env: { NODE_ENV: "production" } };`,
